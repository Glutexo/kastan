...
enum LocalizationKey: String, CaseIterable {
    ...
    case unsupportedConnectionOptionForTimetable = "error.unsupportedConnectionOptionForTimetable"
    case invalidOutputFormat = "error.invalidOutputFormat"
    case invalidNonNegativeInteger = "error.invalidNonNegativeInteger"
    case invalidIntegerMinimum = "error.invalidIntegerMinimum"
    case invalidOptionValue = "error.invalidOptionValue"
    ...
    case usageStationTimetables = "usage.stationTimetables"
    case usageService = "usage.service"
    ...
    case invalidStationTimetableMunicipality = "error.invalidStationTimetableMunicipality"
    case timetableWithoutMunicipality = "error.timetableWithoutMunicipality"
    case networkUnavailable = "error.networkUnavailable"
    case networkUnavailableWithDetail = "error.networkUnavailableWithDetail"
    case emailUnavailable = "error.emailUnavailable"
    ...
    case stationTimetable = "output.stationTimetable"
    case lockoutTimetable = "output.lockoutTimetable"
    case service = "output.service"
    case route = "output.route"
    case information = "output.information"
    ...
    case municipality = "label.municipality"
    ...
    case hour = "label.hour"
    case minutes = "label.minutes"
    case selected = "label.selected"
    ...
    case stationTimetablePlatform = "label.stationTimetablePlatform"
    ...
    case stationTimetablePlatformInline = "inline.stationTimetablePlatform"
    case trackInline = "inline.track"
    case platformTrackInline = "inline.platformTrack"
    case minutesInline = "inline.minutes"
