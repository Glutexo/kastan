...
final class KastanAppTests: XCTestCase {
    ...
    func testServiceNotesReceiveSemanticEmoji() {
        ...
        let passengerServiceNotes = [
            ...
            ("lůžkový vůz", "🛏️"),
            ("lehátkový vůz", "🛌"),
            ("vlak veze přímý vůz (Berlin Hbf (tief)→Břeclav)", "➡️"),
            ...
            ("občerstvení (roznášková služba nebo samoobslužný automat)", "🥤"),
            ...
            ("Bicycle transport is not permitted", "🚳"),
    ...
    func testCompleteConnectionDetailRendersInAnIndependentWindow() {
        XCTAssertEqual(ConnectionDetailView.defaultWindowWidth, 680)
