...
installed_app="$HOME/Applications/Kaštan.app"
live_app="$HOME/project/Build/Products/Debug/Kaštan.app"
stale_app="$TMPDIR/removed/Build/Products/Debug/Kaštan.app"
