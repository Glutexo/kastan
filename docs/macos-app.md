...
- Native tabs and windows, including independent favorite-timetable, complete-connection, and resizable
  ...
  and email disabled until IDOS supplies a permanent link. The favorite-timetable manager, complete connections,
  and service routes all open at their compact 400-point minimum. When scrolling hides the connection's main time
  range, that range moves into the window title until its content label is visible again.
